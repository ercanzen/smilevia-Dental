...
export function PremiumHero() {
  return <section className="premium-hero px-3 pb-16 pt-24 md:px-6 md:pb-24 md:pt-28">
    <div className="relative mx-auto min-h-[760px] max-w-[1480px] overflow-hidden rounded-[32px] bg-[#2c4956] md:rounded-[48px]">
      <img src="/smilevia-media/smilevia-premium-hero-v2.png" alt="" aria-hidden="true" className="absolute inset-0 hidden h-full w-full object-cover object-top opacity-80 motion-reduce:block"/>
      <video autoPlay muted loop playsInline preload="auto" poster="/smilevia-media/smilevia-premium-hero-v2.png" aria-hidden="true" className="absolute inset-0 h-full w-full object-cover object-top opacity-80 motion-reduce:hidden"><source src="/smilevia-media/smilevia-hero-loop-v2.mp4" type="video/mp4"/></video>
